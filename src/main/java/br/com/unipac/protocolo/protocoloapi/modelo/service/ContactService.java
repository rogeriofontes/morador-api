...
import br.com.unipac.protocolo.protocoloapi.modelo.repositorio.ContactRepository;
...
public class ContactService {
    ...
    public Object findAllByName(String name, int pageNumber, int row_per_page) {
        return null;
    }
}
